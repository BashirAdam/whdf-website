...
<div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 border border-gray-200">
  ...
  <p className="text-gray-600 leading-relaxed"> 
   دكتوراة في الإعلام من الجامعة الاميركية بالقاهرة، المستشار الإعلامي الأسبق للرئيس الراحل إدريس ديبي والمستشار المكلف بالبعثات الدبلوماسية السابق للرئيس محمد إدريس ديبي. رئيس أتحاد التلفزة الأفريقي و مؤسس اذاعة النصر (كاول مؤسس اذاعة وتلفزيون من ابناءالكيان، وكاتب ومحلل سياسي متخصص في الشؤون الأفريقية
