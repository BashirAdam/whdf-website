  ...
  return (
    ...
    textAlignLast: "right"}}> تشاد ودول الجوار، في إنجمينا، أبشي، وادي فِرا، أم جرس، إلى جانب جاليات  في ليبيا والنيجر ودول أخرى.    </li>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed text-justify" style={{ direction: 'rtl' }}>
            هو تصور ثقافي وسياسي يهدف إلى إحياء الهوية التاريخية والجغرافية لشعب الزغاوة في السودان، وجعله إقليمًا إداريًا وتنمويًا يُعرف بـ "إقليم وادي هور (إقليم بيربي)". يستند هذا التصور إلى الإرث الحضاري العريق لوادي هور وممالك الزغاوة القديمة، وإلى رغبة الشعب في حماية اللغة والتراث من الاندثار.
          </p>
        </div>
...
<div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 border border-gray-200">
  ...
  <p className="text-gray-600 leading-relaxed" style={{
    textAlign: "justify",
    textAlignLast: "right"}}>
  الأستاذة نجلاء عامر نعمان مهتمة بالتراث وناشطة سياسية، ورئيس اللجنة الاستشارية لرابطة أبناء الزغاوة بمصر
  ...
  (Commented - You can uncomment when needed)
*/}
{/*
<div className="flex flex-col md:flex-row-reverse items-center gap-8">
  <div className="md:w-1/2">
    <img 
      src="/images/Sumaya.jpeg" 
      alt="سمية موسى حران" 
