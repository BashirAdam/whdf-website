...
<section className="py-16 bg-gray-50">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {/* Wide White Card - Matches homepage content width */}
    <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 md:p-10 text-center" dir="rtl">
      ...
      <p className="text-gray-600 mb-10 leading-relaxed max-w-3xl mx-auto text-base md:text-lg">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-[#d78525] hover:bg-[#b8681a] text-white px-7 py-3.5 rounded-xl font-medium transition-colors"
        >
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-2 border-2 border-[#d78525] text-[#d78525] hover:bg-[#d78525] hover:text-white px-7 py-3.5 rounded-xl font-medium transition-colors"
        >
